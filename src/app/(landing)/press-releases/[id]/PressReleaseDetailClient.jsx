                ...
                <div className="max-w-3xl mx-auto px-6 mt-10">
                    <div className="border-t border-gray-200 pt-8">
                        <h4 className="text-xs font-black text-gray-400 mb-3">
                            <Link href="/" className="hover:text-primary transition-colors">About DropPR</Link>
                        </h4>
                        <p className="text-sm text-gray-600 leading-relaxed mb-6">
                            <Link href="/" className="text-primary font-semibold hover:underline">DropPR</Link>{" "}
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed">
                            ...
                            can learn more at <Link href="/" className="text-primary font-semibold hover:underline">DropPR</Link>.
                        </p>
                    </div>
                </div>
                                        ...
                                        <Link key={rc._id} href={`/press-releases/${rc._id}`}
                                            ...
                                            <div className="relative h-44 overflow-hidden bg-gray-100">
                                                ...
                                                <div className="absolute top-3 left-3">
                                                    <span className="bg-primary text-white text-[9px] font-bold px-2.5 py-1 rounded-full tracking-widest shadow-md">DropPR</span>
                                                </div>
                                            </div>
