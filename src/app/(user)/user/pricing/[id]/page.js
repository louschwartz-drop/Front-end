        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8">
          {pricingPlans.map((plan, index) => (
            <motion.div
              ...
              className={`relative bg-white rounded-xl shadow-lg border-2 overflow-hidden ${selectedPlan === plan.id
            ...
            >
              ...
              <div className={`p-4 sm:p-6 ${plan.popular ? "pt-10 sm:pt-12" : ""}`}>
                ...
                <div className="mb-4 sm:mb-6">
                  ...
                  <span className="text-sm sm:text-base text-gray-600 ml-2">/article</span>
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`w-full py-2.5 sm:py-3 rounded-lg font-semibold transition-colors text-sm sm:text-base ${selectedPlan === plan.id
